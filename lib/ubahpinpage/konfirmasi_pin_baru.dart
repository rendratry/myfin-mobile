    ...
    if (pin.length == 6) {
      ...
      if (pin == pinlama){
        ...
        if (data==true){
          ...
          showDialog(context: context, builder: (context) => const AlertDialog(title: const Text("Update Pin Gagal"),));
        }
      }else{
        showDialog(context: context, builder: (context) => const AlertDialog(title: const Text("Konfirmasi Pin Tidak Sama"),));
      }
    } 
    clearAllPin();
  }
